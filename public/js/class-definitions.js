...
Person.prototype.spendMoney = function(monies) {
  this.money -= monies;
};

Person.prototype.earnMoney = function(monies) {
  this.money += monies;
};
...
// Create 2 boxes
var mrsButtCat = new Animal('Cat', 'female');
var catBox = new Box(mrsButtCat, true);
var christmasPresent = new Box('Pony', false);
 ...
 *
 */
Vehicle.prototype.drive = function(street) {
  return street ? 'Driving on ' + street : 'Driving forward';
};
...
var notWarmOrColdAnimal = mrsButtCat.isWarmBlooded();
